        ...
        self.jumper = Jumper(
            {
                ...
                "url-input": "s",
                "collection-tree": "tab",
                "--content-tab-headers-pane": "d",
                "--content-tab-body-pane": "f",
                "--content-tab-path-pane": "g",
                "--content-tab-query-pane": "h",
                "--content-tab-response-body-pane": "j",
                "--content-tab-response-headers-pane": "k",
                "--content-tab-response-cookies-pane": "l",
                "--content-tab-response-scripts-pane": ";",
                "--content-tab-auth-pane": "q",
                "--content-tab-info-pane": "w",
                "--content-tab-scripts-pane": "e",
